...
if not is_torch_available(verbose=False):
    ...
    logger.error("HeteroMapTableSpecification and LLMGeneralCapabilitySpecification are not available because 'torch' is not installed!")
else:
    from .hetero_table import HeteroMapTableSpecification
    from .llm_vector import LLMGeneralCapabilitySpecification
